...
template<typename ItemType> Sequence<ItemType>::Sequence()
{
    createEmpty();
}
...
template<typename ItemType> Sequence<ItemType>::Sequence(const Sequence<ItemType>& other)
{
    createEmpty();
...
template<typename ItemType> Sequence<ItemType>& Sequence<ItemType>::operator=(const Sequence<ItemType>& rhs)
{
    if (this != &rhs)
    {
...
template<typename ItemType> bool Sequence<ItemType>::insert(int pos, const ItemType& value)
{
    if (pos < 0  ||  pos > m_size)
        return false;
...
template<typename ItemType> int Sequence<ItemType>::insert(const ItemType& value)
{
...
template<typename ItemType> bool Sequence<ItemType>::erase(int pos)
{
    if (pos < 0  ||  pos >= m_size)
        return false;
...
template<typename ItemType> int Sequence<ItemType>::remove(const ItemType& value)
{
    int count = 0;
...
template<typename ItemType> bool Sequence<ItemType>::get(int pos, ItemType& value) const
{
    if (pos < 0  ||  pos >= m_size)
        return false;
...
template<typename ItemType> bool Sequence<ItemType>::set(int pos, const ItemType& value)
{
    if (pos < 0  ||  pos >= m_size)
        return false;
...
template<typename ItemType> int Sequence<ItemType>::find(const ItemType& value) const
{
...
template<typename ItemType> void Sequence<ItemType>::swap(Sequence<ItemType>& other)
{
    // Swap head pointers
...
template<typename ItemType> void Sequence<ItemType>::createEmpty()
{
    m_size = 0;
...
template<typename ItemType> void Sequence<ItemType>::insertBefore(Node* p, const ItemType& value)
{
    // Create a new node
...
template<typename ItemType>typename Sequence<ItemType>::Node* Sequence<ItemType>::doErase(Node* p)
{
...
template<typename ItemType>typename Sequence<ItemType>::Node* Sequence<ItemType>::nodeAtPos(int pos) const
{
    Node* p;
